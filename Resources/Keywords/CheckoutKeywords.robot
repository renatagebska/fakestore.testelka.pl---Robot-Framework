...
Fill In Card Details
    Wait Until Element Is Visible               ${BILLING_CARD_NUMBER_INPUT_ID}   timeout=10s
    Click Element                               ${BILLING_CARD_NUMBER_INPUT_ID}
    Input Text                                  ${BILLING_CARD_NUMBER_INPUT_ID}   ${BILLING_CARD_NUMBER}


    Wait Until Element Is Visible               ${BILLING_CARD_EXPIRY_INPUT_ID}    timeout=10s
    Click Element                               ${BILLING_CARD_EXPIRY_INPUT_ID}
    Input Text                                  ${BILLING_CARD_EXPIRY_INPUT_ID}    ${BILLING_CARD_EXPIRY}


    Wait Until Element Is Visible               ${BILLING_CARD_CVC_INPUT_ID}       timeout=10s
    Click Element                               ${BILLING_CARD_CVC_INPUT_ID}
    Input Text                                  ${BILLING_CARD_CVC_INPUT_ID}       ${BILLING_CARD_CVC}